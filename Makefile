...
-include Makefile.supersonic-release
...
supersonic-build-all:
	@python3 scripts/supersonic_build_all.py

supersonic-build-all-publish:
	@python3 scripts/supersonic_build_all.py --publish
...
gh-push-tags:
	@bash -c 'source tools/gh.sh && with_auth_remote git push origin --tags'
	@echo "✅ Pushed tags"
