#!/usr/bin/env python3
"""
Generate Power Label
Script #24 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python power_label.py --out out/{stem}.png
python power_label.py --text 'Label' --out out/power_label.png
