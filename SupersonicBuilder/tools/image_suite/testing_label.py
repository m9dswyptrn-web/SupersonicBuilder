#!/usr/bin/env python3
"""
Generate Testing Label
Script #26 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python testing_label.py --out out/{stem}.png
python testing_label.py --text 'Label' --out out/testing_label.png
