#!/usr/bin/env python3
"""
Generate CAN Bus Label
Script #23 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python canbus_label.py --out out/{stem}.png
python canbus_label.py --text 'Label' --out out/canbus_label.png
