#!/usr/bin/env python3
"""
Generate Legend/Key Label
Script #29 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python legend_key.py --out out/{stem}.png
python legend_key.py --text 'Label' --out out/legend_key.png
