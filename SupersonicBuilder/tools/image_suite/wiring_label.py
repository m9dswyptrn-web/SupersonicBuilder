#!/usr/bin/env python3
"""
Generate Wiring Label
Script #28 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python wiring_label.py --out out/{stem}.png
python wiring_label.py --text 'Label' --out out/wiring_label.png
