#!/usr/bin/env python3
"""
Generate Programming Label
Script #27 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python programming_label.py --out out/{stem}.png
python programming_label.py --text 'Label' --out out/programming_label.png
