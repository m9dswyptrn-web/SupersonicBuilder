#!/usr/bin/env python3
"""
Generate Two-Up Image Cards
Script #08 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python two_up_cards.py --out out/{stem}.png
python two_up_cards.py --items 'Left,Right' --cols 2 --rows 1 --out out/twoup.png
...
def render(items, cols=2, rows=1, cell_w=900, cell_h=600, pad=30):
