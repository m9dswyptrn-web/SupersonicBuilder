...
Script #10 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python callout_tip.py --out out/{stem}.png
python callout_tip.py --head 'Pro Tip' --body 'Label wires before removing harness' --out out/tip.png
...
def render(head: str, body: str, w=1600, h=600):
    ...
    d.rectangle([0, 0, 16, h], fill=(0,173,239,255))
    ft = font(56, True); fs = font(34, False)
    d.text((48, 40), "TIP — " + head, font=ft, fill=FG)
    import textwrap
    y = 130
