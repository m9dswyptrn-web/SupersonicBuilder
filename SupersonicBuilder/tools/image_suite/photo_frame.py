#!/usr/bin/env python3
"""
Generate Photo Frame
Script #38 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python photo_frame.py --out out/{stem}.png
python photo_frame.py --text 'Label' --out out/photo_frame.png
