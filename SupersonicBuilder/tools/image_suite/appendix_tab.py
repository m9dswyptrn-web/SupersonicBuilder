#!/usr/bin/env python3
"""
Generate Appendix Tab
Script #17 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python appendix_tab.py --out out/{stem}.png
python appendix_tab.py --text 'Label' --out out/appendix_tab.png
