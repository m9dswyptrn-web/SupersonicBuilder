#!/usr/bin/env python3
"""
Generate Pinout Block
Script #20 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python pinout_block.py --out out/{stem}.png
python pinout_block.py --text 'Label' --out out/pinout_block.png
