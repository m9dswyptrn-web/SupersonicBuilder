#!/usr/bin/env python3
"""
Generate Connector Block
Script #21 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python connector_block.py --out out/{stem}.png
python connector_block.py --text 'Label' --out out/connector_block.png
