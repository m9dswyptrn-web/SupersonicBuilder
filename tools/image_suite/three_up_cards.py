#!/usr/bin/env python3
"""
Generate Three-Up Image Cards
Script #09 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python three_up_cards.py --out out/{stem}.png
python three_up_cards.py --items 'A,B,C' --cols 3 --rows 1 --out out/threeup.png
...
def render(items, cols=3, rows=1, cell_w=900, cell_h=600, pad=30):
