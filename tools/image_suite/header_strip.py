#!/usr/bin/env python3
"""
Generate Header Strip
Script #05 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python header_strip.py --out out/{stem}.png
python header_strip.py --text 'Disassembly' --out out/header.png
