#!/usr/bin/env python3
"""
Generate Field Card Grid (2x2)
Script #07 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python fieldcard_grid.py --out out/{stem}.png
python fieldcard_grid.py --items 'Step 1,Step 2,Step 3,Step 4' --out out/fieldcards.png
...
def render(items, cols=2, rows=2, cell_w=900, cell_h=600, pad=30):
