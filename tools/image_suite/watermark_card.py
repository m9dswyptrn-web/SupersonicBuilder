#!/usr/bin/env python3
"""
Generate Watermark Card
Script #36 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python watermark_card.py --out out/{stem}.png
python watermark_card.py --text 'Label' --out out/watermark_card.png
