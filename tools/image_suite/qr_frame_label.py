#!/usr/bin/env python3
"""
Generate QR Frame Label
Script #37 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python qr_frame_label.py --out out/{stem}.png
python qr_frame_label.py --text 'Label' --out out/qr_frame_label.png
