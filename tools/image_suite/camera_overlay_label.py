#!/usr/bin/env python3
"""
Generate Camera Overlay Label
Script #22 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python camera_overlay_label.py --out out/{stem}.png
python camera_overlay_label.py --text 'Label' --out out/camera_overlay_label.png
