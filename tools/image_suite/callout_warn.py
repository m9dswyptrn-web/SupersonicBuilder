...
Script #11 — SonicBuilder Image Suite (Dark)
Generated: 2025-10-29 13:56:20 UTC

Usage:
  python callout_warn.py --out out/{stem}.png
python callout_warn.py --head 'Warning' --body 'Disconnect battery before wiring' --out out/warn.png
...
def render(head: str, body: str, w=1600, h=600):
    ...
    d.rectangle([0, 0, 16, h], fill=(240,173,0,255))
    ft = font(56, True); fs = font(34, False)
    d.text((48, 40), "WARNING — " + head, font=ft, fill=FG)
    import textwrap
    y = 130
